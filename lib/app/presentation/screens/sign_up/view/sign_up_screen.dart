...
class SignUpScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    _firstNameTextEditingController.addListener(
        () => signUpCubit.setFirstName(_firstNameTextEditingController.text));
    _lastNameTextEditingController.addListener(
        () => signUpCubit.setLastName(_lastNameTextEditingController.text));
    _emailTextEditingController.addListener(
        () => signUpCubit.setEmail(_emailTextEditingController.text));
    _passwordTextEditingController.addListener(
        () => signUpCubit.setPassword(_passwordTextEditingController.text));
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        MainTextInputField(
                          ...
                          prefixIcon: SvgPicture.asset(
                              ImageAsset.outlinedUsersGroupRoundedSvg),
                        ...
                        MainTextInputField(
                          ...
                          suffixIcon: SvgIconButton(
                            svgPath: signUpCubit.isObscureText
