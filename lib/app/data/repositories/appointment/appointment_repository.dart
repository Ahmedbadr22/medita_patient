...
class AppointmentRepository {
  ...
  Future<Either<Failure, List<Appointment>>> listUserAppointments(int id) async {
    ...
    try {
      List<AppointmentResponse> appointmentsResponse = await _dataSource.listUserAppointments(id);
      List<Appointment> appointments = appointmentsResponse.map((appointment) => appointment.toDomain()).toList();
